...
public class TopeboxNotificationManager {
    ...
    public static void init (Activity activity, int iconId)
    {
        ...
        try {
            ...
            Intent notificationIntent = new Intent(AppContext.CurrentContext, ShadelessAlarmReceiver.class);
            ...
            mCurrentBroadcast = PendingIntent.getBroadcast(mCurrentActivity, 411098, notificationIntent, PendingIntent.FLAG_UPDATE_CURRENT);

...
cd %E_DIR_RELEASE%
%E_JAVA_HOME%\java -classpath .;%E_JXL% GDS_Exporter %E_DIR_DATA%\GDS_Exporter.conf %E_TEMP_DIR%\GDS_Exporter.h %E_TEMP_DIR%\GDS_Exporter.cpp %FILE_1% %FILE_2% %FILE_3% %FILE_4% %FILE_5%
cd %E_PRJ_HOME%

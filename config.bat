...
::Data Compressor
SET COMPRESSOR_TOOL_DIR="%PRJ_DIR%\Tools\compress"
SET COMPRESSOR_CONFIG_FILE_DIR="%PRJ_DIR%\doc\CompressorData"
SET PNG_OPTIMIZE_TOOL_DIR="%PRJ_DIR%\Tools\pngquant"
